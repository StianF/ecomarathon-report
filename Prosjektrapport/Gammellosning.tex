...
\begin{figure}[H]
\centering   
\subfloat[Rammen]{\includegraphics[width=0.5\textwidth]{images/DL1.JPG}}
\subfloat[Hjul]{\includegraphics[width=0.5\textwidth]{images/DL3.JPG}}
...
\begin{figure}[H]
\centering   
\subfloat[Fremre låsing]{\includegraphics[width=0.5\textwidth]{images/DL5.JPG}}
\subfloat[Bakre låsing]{\includegraphics[width=0.5\textwidth]{images/DL4.JPG}}
\caption{Låsingen}
\label{F2}
\end{figure}

Rammen er også utstyrt med bein, slik at bilen kan stå på rammen, ute av tilhengeren. Dette er en fordel om rammen skal brukes ved utstillinger og promoteringsoppdrag.  Se Figur \ref{F3}. 
